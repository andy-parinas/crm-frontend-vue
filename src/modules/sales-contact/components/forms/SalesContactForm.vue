    ...
    <v-form v-model="valid" ref="contactForm">
        <v-container>
            <v-row class="mx-2">
                ...
                <v-col cols="12" sm="6">
                    <PostcodeSelectField :initial-data="form.postcode"
                                    :edit="edit"
                                    @onValueChanged="handlePostcodeSelect"/>
                </v-col>
...
<script>
    import PostcodeSelectField from "./PostcodeSelectField";
    export default {
        name: "SalesContactForm",
        components: {PostcodeSelectField},
        props: {
